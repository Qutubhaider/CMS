...
namespace CMSBAL.User.Models
{
    ...
    {
        //UP.inUserProfileId,UP.unUserProfileId,U.inUserId,UP.inZoneId,UP.inDivisionId,UP.inDepartmentId,UP.inDesignationId,UP.stFirstName,UP.stLastName,UP.stEmail,UP.stMobile,UP.stAddress
