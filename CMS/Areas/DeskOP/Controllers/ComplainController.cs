...
namespace CMS.Areas.DeskOP.Controllers
{
    ...
    public class ComplainController : Controller
    {
        ...
        {
            return View("~/Areas/DeskOP/Views/Complain/ComplainList.cshtml");
        }
        ...
        public IActionResult GetIssueFileList(string fsFileName, int? Status, int? sort_column, string sort_order, int? pg, int? size)
        {
            ...
            try
            {
                ...
                return PartialView("~/Areas/DeskOP/Views/Complain/_ComplainList.cshtml", loModel);
            }
            catch (Exception ex)
            {
        ...
        public IActionResult AddComplain()
        {
            ...
            return View("~/Areas/DeskOP/Views/Complain/AddComplain.cshtml", loComplain);
        }
        [HttpPost]
